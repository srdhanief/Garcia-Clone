!function(e) {
    ...
    Object.assign(s.prototype, {
        ...
        projectOnPlane: function(e) {
            return a.copy(this).projectOnVector(e),
            this.sub(a)
        },
        reflect: function(e) {
    ...
    Object.assign(r.prototype, {
        ...
        setFromEuler: function(e, t) {
            ...
            var n = e._x
              ...
              , d = s(i / 2)
              , f = s(r / 2);
            return "XYZ" === a ? (this._x = h * c * u + l * d * f,
            this._y = l * d * u - h * c * f,
            this._z = l * c * f + h * d * u,
            this._w = l * c * u - h * d * f) : "YXZ" === a ? (this._x = h * c * u + l * d * f,
            this._y = l * d * u - h * c * f,
            this._z = l * c * f - h * d * u,
            this._w = l * c * u + h * d * f) : "ZXY" === a ? (this._x = h * c * u - l * d * f,
            this._y = l * d * u + h * c * f,
            this._z = l * c * f + h * d * u,
            this._w = l * c * u - h * d * f) : "ZYX" === a ? (this._x = h * c * u - l * d * f,
            this._y = l * d * u + h * c * f,
            this._z = l * c * f - h * d * u,
            this._w = l * c * u + h * d * f) : "YZX" === a ? (this._x = h * c * u + l * d * f,
            this._y = l * d * u + h * c * f,
            this._z = l * c * f - h * d * u,
            this._w = l * c * u - h * d * f) : "XZY" === a && (this._x = h * c * u - l * d * f,
            this._y = l * d * u - h * c * f,
            this._z = l * c * f + h * d * u,
            this._w = l * c * u + h * d * f),
        ...
        setFromRotationMatrix: function(e) {
            var t, n = e.elements, i = n[0], r = n[4], a = n[8], o = n[1], s = n[5], l = n[9], c = n[2], u = n[6], h = n[10], d = i + s + h;
            return d > 0 ? (t = .5 / Math.sqrt(d + 1),
            this._w = .25 / t,
            this._x = (u - l) * t,
            this._y = (a - c) * t,
            this._z = (o - r) * t) : i > s && i > h ? (t = 2 * Math.sqrt(1 + i - s - h),
            this._w = (u - l) / t,
            this._x = .25 * t,
            this._y = (r + o) / t,
            this._z = (a + c) / t) : s > h ? (t = 2 * Math.sqrt(1 + s - i - h),
            this._w = (a - c) / t,
            this._x = (r + o) / t,
            this._y = .25 * t,
...
, function(e, t, n) {
    ...
    const a = e=>e.join("");
    var o = {
        uniforms: n(5).a.merge([r.a.common, r.a.envmap, r.a.normalmap, r.a.roughnessmap, r.a.metalnessmap, r.a.lights, {
            map: {
                value: null
            },
            emissive: {
...
, function(e, t, n) {
    ...
    var a, o = n(2), s = n(6), l = function(e) {
        var t;
    ...
    u.prototype = Object.assign(Object.create(r.prototype), {
        ...
        toJSON: function(e) {
            ...
            if (void 0 !== this.image) {
                var r = this.image;
                if (void 0 === r.uuid && (r.uuid = i.a.generateUUID()),
    ...
    var d = n(0)
      , f = [new d.a, new d.a, new d.a, new d.a, new d.a, new d.a, new d.a, new d.a]
      , p = new d.a
      , m = new S
      , g = new d.a
      , v = new d.a
    ...
    Object.assign(S.prototype, {
        ...
        setFromCenterAndSize: function(e, t) {
            var n = p.copy(t).multiplyScalar(.5);
        ...
        intersectsSphere: function(e) {
            return this.clampPoint(e.center, p),
        ...
        intersectsTriangle: function(e) {
            ...
            y.subVectors(_, v),
            M.subVectors(g, _);
            var t = [0, -x.z, x.y, 0, -y.z, y.y, 0, -M.z, M.y, x.z, 0, -x.x, y.z, 0, -y.x, M.z, 0, -M.x, -x.y, x.x, 0, -y.y, y.x, 0, -M.y, M.x, 0];
            return !!A(t, g, v, _, w) && (!!A(t = [1, 0, 0, 0, 1, 0, 0, 0, 1], g, v, _, w) && (E.crossVectors(x, y),
            A(t = [E.x, E.y, E.z], g, v, _, w)))
        },
        ...
        getBoundingSphere: function(e) {
            ...
            e.radius = .5 * this.getSize(p).length(),
            e
        },
        ...
        applyMatrix4: function(e) {
            return this.isEmpty() || (f[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(e),
    ...
    function F(e, t, n, i, r, a) {
        this.planes = [void 0 !== e ? e : new C, void 0 !== t ? t : new C, void 0 !== n ? n : new C, void 0 !== i ? i : new C, void 0 !== r ? r : new C, void 0 !== a ? a : new C]
    }
    Object.assign(F.prototype, {
        ...
        setFromMatrix: function(e) {
            var t = this.planes
              ...
              , v = n[14]
              , _ = n[15];
            return t[0].setComponents(o - i, u - s, p - h, _ - m).normalize(),
        ...
        intersectsSprite: function(e) {
            return I.center.set(0, 0, 0),
            I.radius = .7071067811865476,
        ...
        intersectsBox: function(e) {
            for (var t = this.planes, n = 0; n < 6; n++) {
                var i = t[n];
                if (U.x = i.normal.x > 0 ? e.max.x : e.min.x,
    ...
    Object.assign(W.prototype, {
        ...
        lookAt: function(e, t, n) {
            var i = this.elements;
            return k.subVectors(e, t),
            0 === k.lengthSq() && (k.z = 1),
            k.normalize(),
            V.crossVectors(n, k),
            0 === V.lengthSq() && (1 === Math.abs(n.z) ? k.x += 1e-4 : k.z += 1e-4,
            k.normalize(),
            V.crossVectors(n, k)),
            V.normalize(),
            H.crossVectors(k, V),
        ...
        getInverse: function(e, t) {
            var n = this.elements
              ...
              , _ = i[14]
              , x = i[15]
              , y = f * _ * h - v * p * h + v * u * m - c * _ * m - f * u * x + c * p * x
              , M = g * p * h - d * _ * h - g * u * m + l * _ * m + d * u * x - l * p * x
              , b = d * v * h - g * f * h + g * c * m - l * v * m - d * c * x + l * f * x
              , w = g * f * u - d * v * u - g * c * p + l * v * p + d * c * _ - l * f * _
              , E = r * y + a * M + o * b + s * w;
            if (0 === E) {
            ...
            var S = 1 / E;
            return n[0] = y * S,
            n[1] = (v * p * s - f * _ * s - v * o * m + a * _ * m + f * o * x - a * p * x) * S,
            n[2] = (c * _ * s - v * u * s + v * o * h - a * _ * h - c * o * x + a * u * x) * S,
            n[3] = (f * u * s - c * p * s - f * o * h + a * p * h + c * o * m - a * u * m) * S,
            n[4] = M * S,
            n[5] = (d * _ * s - g * p * s + g * o * m - r * _ * m - d * o * x + r * p * x) * S,
            n[6] = (g * u * s - l * _ * s - g * o * h + r * _ * h + l * o * x - r * u * x) * S,
            n[7] = (l * p * s - d * u * s + d * o * h - r * p * h - l * o * m + r * u * m) * S,
            n[8] = b * S,
            n[9] = (g * f * s - d * v * s - g * a * m + r * v * m + d * a * x - r * f * x) * S,
            n[10] = (l * v * s - g * c * s + g * a * h - r * v * h - l * a * x + r * c * x) * S,
            n[11] = (d * c * s - l * f * s - d * a * h + r * f * h + l * a * m - r * c * m) * S,
            n[12] = w * S,
            n[13] = (d * v * o - g * f * o + g * a * p - r * v * p - d * a * _ + r * f * _) * S,
            n[14] = (g * c * o - l * v * o - g * a * u + r * v * u + l * a * _ - r * c * _) * S,
            n[15] = (l * f * o - d * c * o + d * a * u - r * f * u - l * a * p + r * c * p) * S,
            this
        },
        scale: function(e) {
            var t = this.elements
    ...
    var j = {
      ...
      , Z = {
        basic: {
            uniforms: Object(X.c)([q.a.common, q.a.specularmap, q.a.envmap, q.a.aomap, q.a.lightmap, q.a.fog]),
            vertexShader: j.meshbasic_vert,
            fragmentShader: j.meshbasic_frag
        },
        lambert: {
            uniforms: Object(X.c)([q.a.common, q.a.specularmap, q.a.envmap, q.a.aomap, q.a.lightmap, q.a.emissivemap, q.a.fog, q.a.lights, {
                emissive: {
                    value: new Y.a(0)
                }
            }]),
        ...
        phong: {
            uniforms: Object(X.c)([q.a.common, q.a.specularmap, q.a.envmap, q.a.aomap, q.a.lightmap, q.a.emissivemap, q.a.bumpmap, q.a.normalmap, q.a.displacementmap, q.a.fog, q.a.lights, {
                emissive: {
                    value: new Y.a(0)
                },
                specular: {
        ...
        standard: {
            uniforms: Object(X.c)([q.a.common, q.a.envmap, q.a.aomap, q.a.lightmap, q.a.emissivemap, q.a.bumpmap, q.a.normalmap, q.a.displacementmap, q.a.roughnessmap, q.a.metalnessmap, q.a.fog, q.a.lights, {
                emissive: {
                    value: new Y.a(0)
                },
                roughness: {
        ...
        toon: {
            uniforms: Object(X.c)([q.a.common, q.a.specularmap, q.a.aomap, q.a.lightmap, q.a.emissivemap, q.a.bumpmap, q.a.normalmap, q.a.displacementmap, q.a.gradientmap, q.a.fog, q.a.lights, {
                emissive: {
                    value: new Y.a(0)
                },
                specular: {
        ...
        matcap: {
            uniforms: Object(X.c)([q.a.common, q.a.bumpmap, q.a.normalmap, q.a.displacementmap, q.a.fog, {
                matcap: {
                    value: null
                }
            }]),
        ...
        dashed: {
            uniforms: Object(X.c)([q.a.common, q.a.fog, {
                scale: {
                    value: 1
                },
                dashSize: {
        ...
        normal: {
            uniforms: Object(X.c)([q.a.common, q.a.bumpmap, q.a.normalmap, q.a.displacementmap, {
                opacity: {
                    value: 1
                }
            }]),
        ...
        cube: {
            uniforms: Object(X.c)([q.a.envmap, {
                opacity: {
                    value: 1
                }
            }]),
        ...
        shadow: {
            uniforms: Object(X.c)([q.a.lights, q.a.fog, {
                color: {
                    value: new Y.a(0)
                },
                opacity: {
    ...
    Z.physical = {
        uniforms: Object(X.c)([Z.standard.uniforms, {
            transparency: {
                value: 0
            },
            clearcoat: {
    ...
    Object.assign(J.prototype, {
        ...
        setAxisAngleFromRotationMatrix: function(e) {
            var t, n, i, r, a = e.elements, o = a[0], s = a[4], l = a[8], c = a[1], u = a[5], h = a[9], d = a[2], f = a[6], p = a[10];
            if (Math.abs(s - c) < .01 && Math.abs(l - d) < .01 && Math.abs(h - f) < .01) {
                if (Math.abs(s + c) < .1 && Math.abs(l + d) < .1 && Math.abs(h + f) < .1 && Math.abs(o + u + p - 3) < .1)
            ...
            var M = Math.sqrt((f - h) * (f - h) + (l - d) * (l - d) + (c - s) * (c - s));
    ...
    Object.assign(ee.prototype, {
        ...
        setFromRotationMatrix: function(e, t, n) {
            var r = i.a.clamp
              ...
              , f = a[6]
              , p = a[10];
            return "XYZ" === (t = t || this._order) ? (this._y = Math.asin(r(l, -1, 1)),
            Math.abs(l) < .9999999 ? (this._x = Math.atan2(-h, p),
            this._z = Math.atan2(-s, o)) : (this._x = Math.atan2(f, u),
            this._z = 0)) : "YXZ" === t ? (this._x = Math.asin(-r(h, -1, 1)),
            Math.abs(h) < .9999999 ? (this._y = Math.atan2(l, p),
            this._z = Math.atan2(c, u)) : (this._y = Math.atan2(-d, o),
            this._z = 0)) : "ZXY" === t ? (this._x = Math.asin(r(f, -1, 1)),
            Math.abs(f) < .9999999 ? (this._y = Math.atan2(-d, p),
            this._z = Math.atan2(-s, u)) : (this._y = 0,
            this._z = Math.atan2(c, o))) : "ZYX" === t ? (this._y = Math.asin(-r(d, -1, 1)),
            Math.abs(d) < .9999999 ? (this._x = Math.atan2(f, p),
            this._z = Math.atan2(c, o)) : (this._x = 0,
            this._z = Math.atan2(-s, u))) : "YZX" === t ? (this._z = Math.asin(r(c, -1, 1)),
            Math.abs(c) < .9999999 ? (this._x = Math.atan2(-h, u),
            this._y = Math.atan2(-d, o)) : (this._x = 0,
            this._y = Math.atan2(l, p))) : "XZY" === t ? (this._z = Math.asin(-r(s, -1, 1)),
        ...
        setFromQuaternion: function(e, t, n) {
            return K.makeRotationFromQuaternion(e),
            this.setFromRotationMatrix(K, t, n)
        },
        setFromVector3: function(e, t) {
            return this.set(e.x, e.y, e.z, t || this._order)
        },
        reorder: function(e) {
            return $.setFromEuler(this),
            this.setFromQuaternion($, e)
        },
        equals: function(e) {
            ...
            update: function(n, i) {
                ...
                void 0 === r ? t.set(n, function(t, n) {
                    ...
                    var r = n.array
                      , a = n.updateRange;
                    e.bindBuffer(i, t),
                    -1 === a.count ? e.bufferSubData(i, 0, r) : (e.bufferSubData(i, a.offset * r.BYTES_PER_ELEMENT, r.subarray(a.offset, a.offset + a.count)),
                    a.count = -1)
                }(r.buffer, n, i),
                r.version = n.version)
            }
    ...
    me.prototype = Object.assign(Object.create(r.prototype), {
        ...
        rotateOnAxis: function(e, t) {
            return re.setFromAxisAngle(e, t),
            this.quaternion.multiply(re),
            this
        },
        rotateOnWorldAxis: function(e, t) {
            return re.setFromAxisAngle(e, t),
            this.quaternion.premultiply(re),
            this
        },
        rotateX: function(e) {
        ...
        translateOnAxis: function(e, t) {
            return ie.copy(e).applyQuaternion(this.quaternion),
        ...
        lookAt: function(e, t, n) {
            ...
            this.isCamera || this.isLight ? ae.lookAt(se, oe, this.up) : ae.lookAt(oe, se, this.up),
            this.quaternion.setFromRotationMatrix(ae),
            i && (ae.extractRotation(i.matrixWorld),
        ...
        add: function(e) {
            ...
            e.dispatchEvent(fe)) : console.error("THREE.Object3D.add: object not an instance of THREE.Object3D.", e),
            this)
        },
        remove: function(e) {
            if (arguments.length > 1) {
    ...
    ge.prototype = Object.assign(Object.create(me.prototype), {
        ...
        isScene: !0,
        copy: function(e, t) {
            return me.prototype.copy.call(this, e, t),
    ...
    Ee.prototype = Object.assign(Object.create(r.prototype), {
        ...
        isGeometry: !0,
        applyMatrix: function(e) {
            for (var t = (new s.a).getNormalMatrix(e), n = 0, i = this.vertices.length; n < i; n++) {
        ...
        rotateX: function(e) {
            return Me.makeRotationX(e),
            this.applyMatrix(Me),
            this
        },
        rotateY: function(e) {
            return Me.makeRotationY(e),
            this.applyMatrix(Me),
            this
        },
        rotateZ: function(e) {
            return Me.makeRotationZ(e),
            this.applyMatrix(Me),
            this
        },
        translate: function(e, t, n) {
            return Me.makeTranslation(e, t, n),
            this.applyMatrix(Me),
            this
        },
        scale: function(e, t, n) {
            return Me.makeScale(e, t, n),
            this.applyMatrix(Me),
            this
        },
        lookAt: function(e) {
        ...
        fromBufferGeometry: function(e) {
            ...
            function h(e, n, i, r) {
                var u = void 0 === s ? [] : [t.colors[e].clone(), t.colors[n].clone(), t.colors[i].clone()]
                  , h = new xe(e,n,i,void 0 === a ? [] : [(new d.a).fromArray(a, 3 * e), (new d.a).fromArray(a, 3 * n), (new d.a).fromArray(a, 3 * i)],u,r);
                t.faces.push(h),
                void 0 !== l && t.faceVertexUvs[0].push([(new o.a).fromArray(l, 2 * e), (new o.a).fromArray(l, 2 * n), (new o.a).fromArray(l, 2 * i)]),
                void 0 !== c && t.faceVertexUvs[1].push([(new o.a).fromArray(c, 2 * e), (new o.a).fromArray(c, 2 * n), (new o.a).fromArray(c, 2 * i)])
            }
            var f = e.groups;
            if (f.length > 0)
                for (u = 0; u < f.length; u++)
                    for (var p = f[u], m = p.start, g = m, v = m + p.count; g < v; g += 3)
                        void 0 !== n ? h(n[g], n[g + 1], n[g + 2], p.materialIndex) : h(g, g + 1, g + 2, p.materialIndex);
            else if (void 0 !== n)
        ...
        computeFaceNormals: function() {
            for (var e = new d.a, t = new d.a, n = 0, i = this.faces.length; n < i; n++) {
                var r = this.faces[n]
                  , a = this.vertices[r.a]
                  , o = this.vertices[r.b]
                  , s = this.vertices[r.c];
        ...
        computeVertexNormals: function(e) {
            ...
            r = this.faces.length; i < r; i++) {
                ...
                3 === f.length ? (f[0].copy(o[a.a]),
                f[1].copy(o[a.b]),
                f[2].copy(o[a.c])) : (f[0] = o[a.a].clone(),
                f[1] = o[a.b].clone(),
                f[2] = o[a.c].clone())
            }
        ...
        merge: function(e, t, n) {
            if (e && e.isGeometry) {
                var i, r = this.vertices.length, a = this.vertices, o = e.vertices, l = this.faces, c = e.faces, u = this.colors, h = e.colors;
                void 0 === n && (n = 0),
                ...
                for (d = 0,
                f = e.faceVertexUvs.length; d < f; d++) {
        ...
        mergeVertices: function() {
            var e, t, n, i, r, a, o, s, l = {}, c = [], u = [], h = Math.pow(10, 4);
            for (n = 0,
    ...
    Object.assign(Fe.prototype, {
        ...
        fromGeometry: function(e) {
            ...
            var h, d = e.morphNormals, f = d.length;
            if (f > 0) {
                h = [];
                for (u = 0; u < f; u++)
                    h[u] = {
            ...
            for (u = 0; u < n.length; u++) {
                ...
                if (!0 === a)
                    void 0 !== (M = r[0][u]) ? this.uvs.push(M[0], M[1], M[2]) : (console.warn("THREE.DirectGeometry.fromGeometry(): Undefined vertexUv ", u),
                    this.uvs.push(new o.a, new o.a, new o.a));
                if (!0 === s)
                    void 0 !== (M = r[1][u]) ? this.uvs2.push(M[0], M[1], M[2]) : (console.warn("THREE.DirectGeometry.fromGeometry(): Undefined vertexUv2 ", u),
    ...
    je.prototype = Object.assign(Object.create(r.prototype), {
        ...
        setIndex: function(e) {
            Array.isArray(e) ? this.index = new (Oe(e) > 65535 ? Ce : Ne)(e,1) : this.index = e
        },
        ...
        rotateX: function(e) {
            return Be.makeRotationX(e),
            this.applyMatrix(Be),
            this
        },
        rotateY: function(e) {
            return Be.makeRotationY(e),
            this.applyMatrix(Be),
            this
        },
        rotateZ: function(e) {
            return Be.makeRotationZ(e),
            this.applyMatrix(Be),
            this
        },
        translate: function(e, t, n) {
            return Be.makeTranslation(e, t, n),
            this.applyMatrix(Be),
            this
        },
        scale: function(e, t, n) {
            return Be.makeScale(e, t, n),
            this.applyMatrix(Be),
            this
        },
        lookAt: function(e) {
        ...
        setFromPoints: function(e) {
            ...
            return this.setAttribute("position", new Ie(t,3)),
            this
        },
        ...
        fromGeometry: function(e) {
            return e.__directGeometry = (new Fe).fromGeometry(e),
            this.fromDirectGeometry(e.__directGeometry)
        },
        fromDirectGeometry: function(e) {
            var t = new Float32Array(3 * e.vertices.length);
            if (this.setAttribute("position", new Se(t,3).copyVector3sArray(e.vertices)),
            e.normals.length > 0) {
                var n = new Float32Array(3 * e.normals.length);
                this.setAttribute("normal", new Se(n,3).copyVector3sArray(e.normals))
            }
            ...
            if (void 0 !== e) {
                ...
                t)
                    for (var n = 0, i = t.length; n < i; n++) {
                        ...
                        this.morphTargetsRelative ? (We.addVectors(this.boundingBox.min, He.min),
                        this.boundingBox.expandByPoint(We),
                        We.addVectors(this.boundingBox.max, He.max),
                        this.boundingBox.expandByPoint(We)) : (this.boundingBox.expandByPoint(He.min),
        ...
        computeBoundingSphere: function() {
            ...
            if (e) {
                ...
                if (He.setFromBufferAttribute(e),
                t)
                    for (var i = 0, r = t.length; i < r; i++) {
                        var a = t[i];
                        ke.setFromBufferAttribute(a),
                        this.morphTargetsRelative ? (We.addVectors(He.min, ke.min),
                        He.expandByPoint(We),
                        We.addVectors(He.max, ke.max),
                        He.expandByPoint(We)) : (He.expandByPoint(ke.min),
                        He.expandByPoint(ke.max))
                    }
                He.getCenter(n);
                var o = 0;
                for (i = 0,
            ...
            if (t.position) {
                ...
                if (void 0 === t.normal)
                    ...
                    for (var i = t.normal.array, r = 0, a = i.length; r < a; r++)
                        i[r] = 0;
                var o, s, l, c = t.normal.array, u = new d.a, h = new d.a, f = new d.a, p = new d.a, m = new d.a;
                if (e) {
                    var g = e.array;
                    for (r = 0,
                    a = e.count; r < a; r += 3)
            ...
            if (e && e.isBufferGeometry) {
                ...
                for (var i in n)
                    if (void 0 !== e.attributes[i])
                        for (var r = n[i].array, a = e.attributes[i], o = a.array, s = a.itemSize * t, l = Math.min(o.length, r.length - s), c = 0, u = s; c < l; c++,
                        u++)
                            r[u] = o[c];
                return this
            }
    ...
    class Xe extends je {
        constructor(e, t, n, i, r, a) {
            ...
            function p(e, t, n, i, r, a, p, m, g, v, _) {
                var x, y, M = a / g, b = p / v, w = a / 2, E = p / 2, T = m / 2, S = g + 1, A = v + 1, L = 0, R = 0, P = new d.a;
                for (y = 0; y < A; y++) {
                    var N = y * b - E;
                    for (x = 0; x < S; x++) {
                        var D = x * M - w;
    ...
    function Ye(e, t, n, i) {
        ...
        var r, a, o = (e = e || 1) / 2, s = (t = t || 1) / 2, l = Math.floor(n) || 1, c = Math.floor(i) || 1, u = l + 1, h = c + 1, d = e / l, f = t / c, p = [], m = [], g = [], v = [];
        for (a = 0; a < h; a++) {
            var _ = a * f - s;
            for (r = 0; r < u; r++) {
                var x = r * d - o;
    ...
    Qe.prototype.copy = function(e) {
        return Je.prototype.copy.call(this, e),
    ...
    Object.assign(at.prototype, {
        ...
        recast: function(e) {
            return this.origin.copy(this.at(e, Ke)),
            this
        },
        ...
        distanceSqToPoint: function(e) {
            ...
            return t < 0 ? this.origin.distanceToSquared(e) : (Ke.copy(this.direction).multiplyScalar(t).add(this.origin),
            Ke.distanceToSquared(e))
        },
        distanceSqToSegment: function(e, t, n, i) {
            $e.copy(e).add(t).multiplyScalar(.5),
            et.copy(t).sub(e).normalize(),
            tt.copy(this.origin).sub($e);
            var r, a, o, s, l = .5 * e.distanceTo(t), c = -this.direction.dot(et), u = tt.dot(this.direction), h = -tt.dot(et), d = tt.lengthSq(), f = Math.abs(1 - c * c);
            if (f > 0)
                if (a = c * u - h,
                s = l * f,
                (r = c * h - u) >= 0)
                    if (a >= -s)
                        if (a <= s) {
                            var p = 1 / f;
                            o = (r *= p) * (r + c * (a *= p) + 2 * u) + a * (c * r + a + 2 * h) + d
                        } else
                            a = l,
                    ...
                    a <= -s ? o = -(r = Math.max(0, -(-c * l + u))) * r + (a = r > 0 ? -l : Math.min(Math.max(-l, -h), l)) * (a + 2 * h) + d : a <= s ? (r = 0,
                    o = (a = Math.min(Math.max(-l, -h), l)) * (a + 2 * h) + d) : o = -(r = Math.max(0, -(c * l + u))) * r + (a = r > 0 ? l : Math.min(Math.max(-l, -h), l)) * (a + 2 * h) + d;
            else
                a = c > 0 ? -l : l,
                o = -(r = Math.max(0, -(c * a + u))) * r + a * (a + 2 * h) + d;
        ...
        intersectBox: function(e, t) {
            var n, i, r, a, o, s, l = 1 / this.direction.x, c = 1 / this.direction.y, u = 1 / this.direction.z, h = this.origin;
        ...
        intersectTriangle: function(e, t, n, i, r) {
            nt.subVectors(t, e),
            it.subVectors(n, e),
            rt.crossVectors(nt, it);
            var a, o = this.direction.dot(rt);
            if (o > 0) {
                if (i)
                    return null;
                a = 1
    ...
    Object.assign(gt, {
        ...
        containsPoint: function(e, t, n, i) {
            return gt.getBarycoord(e, t, n, i, ct),
            ct.x >= 0 && ct.y >= 0 && ct.x + ct.y <= 1
        },
        getUV: function(e, t, n, i, r, a, o, s) {
            return this.getBarycoord(e, t, n, i, ct),
            s.set(0, 0),
    ...
    Object.assign(gt.prototype, {
        ...
        closestPointToPoint: function(e, t) {
            ...
            if (m <= 0 && l >= 0 && p <= 0)
                return i = l / (l - p),
                t.copy(r).addScaledVector(ht, i);
            var g = c * p - f * u;
            if (g <= 0 && u - c >= 0 && f - p >= 0)
                return dt.subVectors(o, a),
                i = (u - c) / (u - c + (f - p)),
    ...
    function Ut(e, t) {
        ...
        this.material = void 0 !== t ? t : new vt({
    ...
    function Ot(e, t, n, i, r, a, s, l, c, u, h, d) {
        ...
        if (t.morphTargets && a && f) {
            ...
            for (var p = 0, m = a.length; p < m; p++) {
                var g = f[p]
                  , v = a[p];
                0 !== g && (Et.fromBufferAttribute(v, u),
                Tt.fromBufferAttribute(v, h),
                St.fromBufferAttribute(v, d),
                s ? (At.addScaledVector(Et, g),
                Lt.addScaledVector(Tt, g),
                Rt.addScaledVector(St, g)) : (At.addScaledVector(Et.sub(Mt), g),
    ...
    function zt(e, t, n, i) {
        ...
        return {
            ...
            render: function(t, i, h, d) {
                ...
                null === f ? (u(o, s),
                l = null,
                c = 0) : f && f.isColor && (u(f, 1),
                d = !0,
                l = null,
                c = 0),
                (e.autoClear || d) && e.clear(e.autoClearColor, e.autoClearDepth, e.autoClearStencil),
                f && (f.isCubeTexture || f.isWebGLRenderTargetCube || 306 === f.mapping)) {
                    void 0 === a && ((a = new Ut(new Xe(1,1,1),new Qe({
                    ...
                    l === f && c === g.version || (a.material.needsUpdate = !0,
                    l = f,
                    c = g.version),
                    t.unshift(a, a.geometry, a.material, 0, 0, null)
                } else
                    f && f.isTexture && (void 0 === r && ((r = new Ut(new Ye(2,2),new Qe({
                    ...
                    l === f && c === f.version || (r.material.needsUpdate = !0,
                    l = f,
                    c = f.version),
    ...
    function kt(e, t, n) {
        ...
        function o(n) {
            ...
            p.version = s,
            t.update(p, e.ELEMENT_ARRAY_BUFFER);
            var m = r.get(n);
            m && t.remove(m),
            r.set(n, p)
        }
    ...
    function qt(e) {
        ...
        return {
            update: function(i, r, a, o) {
                ...
                for (u = 0; u < l; u++) {
                    0 !== (p = c[u])[1] && (h && r.deleteAttribute("morphTarget" + u),
        ...
        return {
            update: function(a) {
                var o = i.render.frame
                  , s = a.geometry
                  , l = t.get(a, s);
                return r[l.id] !== o && (s.isGeometry && l.updateFromObject(a),
                t.update(l),
                r[l.id] = o),
    ...
    Ut.prototype = Object.assign(Object.create(me.prototype), {
        ...
        isMesh: !0,
        copy: function(e) {
            return me.prototype.copy.call(this, e),
        ...
        raycast: function(e, t) {
            ...
            yt.applyMatrix4(a),
            !1 !== e.ray.intersectsSphere(yt) && (_t.getInverse(a),
            xt.copy(e.ray).applyMatrix4(_t),
            null === i.boundingBox || !1 !== xt.intersectsBox(i.boundingBox))))
                if (i.isBufferGeometry) {
                    var s, l, c, u, h, d, f, p, m, g = i.index, v = i.attributes.position, _ = i.morphAttributes.position, x = i.morphTargetsRelative, y = i.attributes.uv, M = i.attributes.uv2, b = i.groups, w = i.drawRange;
                    if (null !== g)
                        if (Array.isArray(r))
                            for (u = 0,
                            d = b.length; u < d; u++)
                                for (m = r[(p = b[u]).materialIndex],
                                h = Math.max(p.start, w.start),
                                f = Math.min(p.start + p.count, w.start + w.count); h < f; h += 3)
                                    s = g.getX(h),
                                    l = g.getX(h + 1),
                                    c = g.getX(h + 2),
                                    (n = Ot(this, m, e, xt, v, _, x, y, M, s, l, c)) && (n.faceIndex = Math.floor(h / 3),
                                    n.face.materialIndex = p.materialIndex,
                                    t.push(n));
                        else
                            for (u = Math.max(0, w.start),
                            d = Math.min(g.count, w.start + w.count); u < d; u += 3)
                                s = g.getX(u),
                                l = g.getX(u + 1),
                                c = g.getX(u + 2),
                                (n = Ot(this, r, e, xt, v, _, x, y, M, s, l, c)) && (n.faceIndex = Math.floor(u / 3),
                                t.push(n));
                    else if (void 0 !== v)
                        if (Array.isArray(r))
                            for (u = 0,
                            d = b.length; u < d; u++)
                                ...
                                h = Math.max(p.start, w.start),
                                f = Math.min(p.start + p.count, w.start + w.count); h < f; h += 3)
                                    (n = Ot(this, m, e, xt, v, _, x, y, M, s = h, l = h + 1, c = h + 2)) && (n.faceIndex = Math.floor(h / 3),
                                    n.face.materialIndex = p.materialIndex,
                                    t.push(n));
                        else
                            for (u = Math.max(0, w.start),
                            d = Math.min(v.count, w.start + w.count); u < d; u += 3)
                                (n = Ot(this, r, e, xt, v, _, x, y, M, s = u, l = u + 1, c = u + 2)) && (n.faceIndex = Math.floor(u / 3),
                                t.push(n))
                } else if (i.isGeometry) {
                    var E, T, S, A, L = Array.isArray(r), R = i.vertices, P = i.faces, N = i.faceVertexUvs[0];
                    N.length > 0 && (A = N);
    ...
    function gn(e, t) {
        ...
        if (void 0 === i) {
            ...
            if (cn(n, i))
                return;
            sn.set(i),
            e.uniformMatrix2fv(this.addr, !1, sn),
            un(n, i)
        }
    }
    function vn(e, t) {
        ...
        if (void 0 === i) {
            ...
            if (cn(n, i))
                return;
            on.set(i),
            e.uniformMatrix3fv(this.addr, !1, on),
            un(n, i)
        }
    }
    function _n(e, t) {
        ...
        if (void 0 === i) {
            ...
            if (cn(n, i))
                return;
            an.set(i),
            e.uniformMatrix4fv(this.addr, !1, an),
            un(n, i)
        }
    }
    function xn(e, t, n) {
    ...
    function En(e, t) {
        var n = this.cache;
        cn(n, t) || (e.uniform2iv(this.addr, t),
        un(n, t))
    }
    function Tn(e, t) {
        var n = this.cache;
        cn(n, t) || (e.uniform3iv(this.addr, t),
        un(n, t))
    }
    function Sn(e, t) {
        var n = this.cache;
        cn(n, t) || (e.uniform4iv(this.addr, t),
        un(n, t))
    }
    function An(e, t) {
    ...
    function Bn(e, t, n) {
        ...
        e.uniform1iv(this.addr, r);
        for (var a = 0; a !== i; ++a)
            n.safeSetTextureCube(t[a] || tn, r[a])
    }
    function Gn(e, t, n) {
        this.id = e,
        this.addr = n,
    ...
    function ci(e, t, n, i, r, a) {
        var o, s, l, c, u, h = e.getContext(), d = i.defines, f = r.vertexShader, p = r.fragmentShader, m = function(e) {
            ...
            return t
        }(a), x = e.gammaFactor > 0 ? e.gammaFactor : 1, y = a.isWebGL2 ? "" : function(e, t, n) {
            return [(e = e || {}).derivatives || t.envMapCubeUV || t.bumpMap || t.tangentSpaceNormalMap || t.clearcoatNormalMap || t.flatShading || "physical" === t.shaderID ? "#extension GL_OES_standard_derivatives : enable" : "", (e.fragDepth || t.logarithmicDepthBuffer) && n.get("EXT_frag_depth") ? "#extension GL_EXT_frag_depth : enable" : "", e.drawBuffers && n.get("WEBGL_draw_buffers") ? "#extension GL_EXT_draw_buffers : require" : "", (e.shaderTextureLOD || t.envMap) && n.get("EXT_shader_texture_lod") ? "#extension GL_EXT_shader_texture_lod : enable" : ""].filter($n).join("\n")
        }(i.extensions, a, t), M = function(e) {
            var t = [];
            for (var n in e) {
                var i = e[n];
        ...
        var S, A, L = o + f, R = s + p, P = qn(h, h.VERTEX_SHADER, L), N = qn(h, h.FRAGMENT_SHADER, R);
        if (h.attachShader(b, P),
        h.attachShader(b, N),
        void 0 !== i.index0AttributeName ? h.bindAttribLocation(b, 0, i.index0AttributeName) : !0 === a.morphTargets && h.bindAttribLocation(b, 0, "position"),
        h.linkProgram(b),
        e.debug.checkShaderErrors) {
            ...
            if (!1 === h.getProgramParameter(b, h.LINK_STATUS)) {
                ...
                var O = Jn(h, P, "vertex")
                  , z = Jn(h, N, "fragment");
                console.error("THREE.WebGLProgram: shader error: ", h.getError(), "gl.VALIDATE_STATUS", h.getProgramParameter(b, h.VALIDATE_STATUS), "gl.getProgramInfoLog", D, O, z)
            } else
                "" !== D ? console.warn("THREE.WebGLProgram: gl.getProgramInfoLog()", D) : "" !== C && "" !== I || (F = !1);
            F && (this.diagnostics = {
                runnable: U,
                material: i,
                programLog: D,
        ...
        return h.deleteShader(P),
        h.deleteShader(N),
        this.getUniforms = function() {
            return void 0 === S && (S = new Xn(h,b)),
            S
        }
        ,
    ...
    function ui(e, t, n) {
        ...
        this.getProgramCacheKey = function(t, n) {
            var i = [];
            if (n.shaderID ? i.push(n.shaderID) : (i.push(t.fragmentShader),
        ...
        this.acquireProgram = function(n, r, a, o) {
            ...
            return void 0 === s && (s = new ci(e,t,o,n,r,a),
            i.push(s)),
            s
        }
        ,
    ...
    function mi() {
        ...
        return {
            get: function(n, i) {
                ...
                e.set(n, new WeakMap),
                e.get(n).set(i, r),
                n.addEventListener("dispose", t)) : void 0 === (r = a.get(i)) && (r = new pi,
                a.set(i, r)),
                r
            },
            dispose: function() {
            ...
            setup: function(n, o, s) {
                ...
                for (var M = n.length; h < M; h++) {
                    ...
                    if (b.isAmbientLight)
                        ...
                        if ((R = e.get(b)).color.copy(b.color).multiplyScalar(b.intensity),
                        ...
                        if ((R = e.get(b)).position.setFromMatrixPosition(b.matrixWorld),
                        ...
                        r.premultiply(y),
                        a.extractRotation(r),
                        R.halfWidth.set(.5 * b.width, 0, 0),
                        R.halfHeight.set(0, .5 * b.height, 0),
                ...
                t.ambient[2] = u;
                var P = t.hash;
                P.directionalLength === d && P.pointLength === f && P.spotLength === p && P.rectAreaLength === m && P.hemiLength === g && P.numDirectionalShadows === v && P.numPointShadows === _ && P.numSpotShadows === x || (t.directional.length = d,
                t.spot.length = p,
                t.rectArea.length = m,
                t.point.length = f,
                t.hemi.length = g,
    ...
    function Mi() {
        ...
        return {
            get: function(n, i) {
                var r;
                return !1 === e.has(n) ? (r = new yi,
                e.set(n, new WeakMap),
                e.get(n).set(i, r),
                n.addEventListener("dispose", t)) : !1 === e.get(n).has(i) ? (r = new yi,
    ...
    function bi(e, t, n) {
        ...
        n = n || {},
        this.texture = new u(void 0,void 0,n.wrapS,n.wrapT,n.magFilter,n.minFilter,n.format,n.type,n.anisotropy,n.encoding),
        this.texture.image = {},
    ...
    function Ti(e, t, n) {
        ...
        var p = new je;
        p.setAttribute("position", new Se(new Float32Array([-1, -1, .5, 3, -1, .5, -1, 3, .5]),3));
        var m = new Ut(p,d)
          , g = this;
        function v(n, i) {
            var r = t.update(m);
        ...
        function y(t, n, i, r, a, o) {
            ...
            l.side = 3 === o ? null !== n.shadowSide ? n.shadowSide : n.side : null !== n.shadowSide ? n.shadowSide : h[n.side],
            ...
            if (!1 !== g.enabled && (!1 !== g.autoUpdate || !1 !== g.needsUpdate) && 0 !== t.length) {
                ...
                for (var f = 0, p = t.length; f < p; f++) {
                    ...
                    if (void 0 !== _) {
                        ...
                        if (r.multiply(x),
                        a.copy(_.mapSize),
                        (r.x > n || r.y > n) && (console.warn("THREE.WebGLShadowMap:", m, "has shadow exceeding max texture size, reducing"),
                        r.x > n && (a.x = Math.floor(n / x.x),
                        r.x = a.x * x.x,
                        _.mapSize.x = a.x),
    ...
    function Si(e, t, n) {
        ...
        L = R >= 1) : -1 !== P.indexOf("OpenGL ES") && (R = parseFloat(/^OpenGL\ ES\ ([0-9])/.exec(P)[1]),
        L = R >= 2);
        var N = null
          , D = {}
          , C = new J
        ...
        function O(n, r) {
            ...
            c[n] = 1),
            u[n] !== r) && ((i ? e : t.get("ANGLE_instanced_arrays"))[i ? "vertexAttribDivisor" : "vertexAttribDivisorANGLE"](n, r),
            u[n] = r)
        }
        function z(t) {
            !0 !== h[t] && (e.enable(t),
        ...
        F[e.TEXTURE_CUBE_MAP] = U(e.TEXTURE_CUBE_MAP, e.TEXTURE_CUBE_MAP_POSITIVE_X, 6),
        r.setClear(0, 0, 0, 1),
        a.setClear(1),
        o.setClear(0),
        z(e.DEPTH_TEST),
        ...
        function k(t, n, i, r, a, o, s, l) {
            if (0 !== t) {
                ...
                5 === t)
                    ...
                    m = n,
                    _ = a),
                    i === g && r === v && o === x && s === y || (e.blendFuncSeparate(H[i], H[r], H[o], H[s]),
                    g = i,
                    v = r,
                    x = o,
                    y = s),
        ...
        function j(t) {
            0 !== t ? (z(e.CULL_FACE),
            t !== w && (1 === t ? e.cullFace(e.BACK) : 2 === t ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK))) : B(e.CULL_FACE),
            w = t
        }
        function X(t, n, i) {
            t ? (z(e.POLYGON_OFFSET_FILL),
            T === n && S === i || (e.polygonOffset(n, i),
            T = n,
            S = i)) : B(e.POLYGON_OFFSET_FILL)
        }
        function q(t) {
            void 0 === t && (t = e.TEXTURE0 + A - 1),
            N !== t && (e.activeTexture(t),
            N = t)
        }
        return {
            buffers: {
            ...
            scissor: function(t) {
                !1 === C.equals(t) && (e.scissor(t.x, t.y, t.z, t.w),
                C.copy(t))
            },
            viewport: function(t) {
    ...
    function Ai(e, t, n, r, a, o, s) {
        var l, c = a.isWebGL2, u = a.maxTextures, h = a.maxCubemapSize, d = a.maxTextureSize, f = a.maxSamples, p = new WeakMap, m = !1;
        try {
        ...
        function M(n, i, r) {
            ...
            a === e.R16F || a === e.R32F || a === e.RGBA16F || a === e.RGBA32F ? t.get("EXT_color_buffer_float") : a !== e.RGB16F && a !== e.RGB32F || console.warn("THREE.WebGLRenderer: Floating point textures with RGB format not supported. Please use RGBA instead."),
            a
        }
        function b(t) {
        ...
        function A(t, i) {
            if (6 === t.image.length) {
                ...
                if (t.version > 0 && a.__version !== t.version) {
                    ...
                    for (var s = t && t.isCompressedTexture, l = t.image[0] && t.image[0].isDataTexture, u = [], d = 0; d < 6; d++)
                        u[d] = s || l ? l ? t.image[d].image : t.image[d] : v(t.image[d], !1, !0, h);
                    var f, p = u[0], m = _(p) || c, g = o.convert(t.format), b = o.convert(t.type), w = M(t.internalFormat, g, b);
                    if (N(e.TEXTURE_CUBE_MAP, t, m),
                    s) {
                        for (d = 0; d < 6; d++) {
                            f = u[d].mipmaps;
                            for (var E = 0; E < f.length; E++) {
                                var T = f[E];
                                1023 !== t.format && 1022 !== t.format ? null !== g ? n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + d, E, w, T.width, T.height, 0, T.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()") : n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + d, E, w, T.width, T.height, 0, g, b, T.data)
                            }
                        }
                        ...
                        for (d = 0; d < 6; d++)
                            if (l) {
                                n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + d, 0, w, u[d].width, u[d].height, 0, g, b, u[d].data);
                                for (E = 0; E < f.length; E++) {
                                    var S = (T = f[E]).image[d].image;
                                    n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + d, E + 1, w, S.width, S.height, 0, g, b, S.data)
                                }
                            } else {
                                n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + d, 0, w, g, b, u[d]);
                                for (E = 0; E < f.length; E++) {
                                    T = f[E];
                                    n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + d, E + 1, w, g, b, T.image[d])
                                }
                            }
        ...
        function N(n, i, o) {
            o ? (e.texParameteri(n, e.TEXTURE_WRAP_S, R[i.wrapS]),
            e.texParameteri(n, e.TEXTURE_WRAP_T, R[i.wrapT]),
            n !== e.TEXTURE_3D && n !== e.TEXTURE_2D_ARRAY || e.texParameteri(n, e.TEXTURE_WRAP_R, R[i.wrapR]),
            e.texParameteri(n, e.TEXTURE_MAG_FILTER, P[i.magFilter]),
            e.texParameteri(n, e.TEXTURE_MIN_FILTER, P[i.minFilter])) : (e.texParameteri(n, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE),
            ...
            1001 === i.wrapS && 1001 === i.wrapT || console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),
            e.texParameteri(n, e.TEXTURE_MAG_FILTER, b(i.magFilter)),
            e.texParameteri(n, e.TEXTURE_MIN_FILTER, b(i.minFilter)),
            1003 !== i.minFilter && 1006 !== i.minFilter && console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter."));
            var s = t.get("EXT_texture_filter_anisotropic");
            if (s) {
                if (1015 === i.type && null === t.get("OES_texture_float_linear"))
                    return;
                if (1016 === i.type && null === (c || t.get("OES_texture_half_float_linear")))
                    return;
                (i.anisotropy > 1 || r.get(i).__currentAnisotropy) && (e.texParameterf(n, s.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(i.anisotropy, a.getMaxAnisotropy())),
        ...
        function C(t, i, r) {
            ...
            var m, g = i.mipmaps;
            if (i.isDepthTexture) {
                if (p = e.DEPTH_COMPONENT,
                1015 === i.type) {
                    if (!1 === c)
                        throw new Error("Float Depth Texture only supported in WebGL2.0");
                    p = e.DEPTH_COMPONENT32F
                } else
                    c && (p = e.DEPTH_COMPONENT16);
                1026 === i.format && p === e.DEPTH_COMPONENT && 1012 !== i.type && 1014 !== i.type && (console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),
                i.type = 1012,
                f = o.convert(i.type)),
                1027 === i.format && (p = e.DEPTH_STENCIL,
                ...
                if (g.length > 0 && u) {
                    for (var b = 0, w = g.length; b < w; b++)
                        m = g[b],
                        n.texImage2D(e.TEXTURE_2D, b, p, m.width, m.height, 0, h, f, m.data);
                    i.generateMipmaps = !1,
                    t.__maxMipLevel = g.length - 1
                } else
                    n.texImage2D(e.TEXTURE_2D, 0, p, l.width, l.height, 0, h, f, l.data),
                    t.__maxMipLevel = 0;
            else if (i.isCompressedTexture) {
                for (b = 0,
                w = g.length; b < w; b++)
                    m = g[b],
                    1023 !== i.format && 1022 !== i.format ? null !== h ? n.compressedTexImage2D(e.TEXTURE_2D, b, p, m.width, m.height, 0, m.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : n.texImage2D(e.TEXTURE_2D, b, p, m.width, m.height, 0, h, f, m.data);
                t.__maxMipLevel = g.length - 1
            } else if (i.isDataTexture2DArray)
                n.texImage3D(e.TEXTURE_2D_ARRAY, 0, p, l.width, l.height, l.depth, 0, h, f, l.data),
                t.__maxMipLevel = 0;
            else if (i.isDataTexture3D)
                n.texImage3D(e.TEXTURE_3D, 0, p, l.width, l.height, l.depth, 0, h, f, l.data),
                t.__maxMipLevel = 0;
            else if (g.length > 0 && u) {
                for (b = 0,
                w = g.length; b < w; b++)
                    m = g[b],
                    n.texImage2D(e.TEXTURE_2D, b, p, h, f, m);
                i.generateMipmaps = !1,
                t.__maxMipLevel = g.length - 1
            } else
                n.texImage2D(e.TEXTURE_2D, 0, p, h, f, l),
                t.__maxMipLevel = 0;
        ...
        function U(t, n, i) {
            ...
            n.depthBuffer && !n.stencilBuffer) {
                ...
                if (i) {
                    r = O(n);
                    e.renderbufferStorageMultisample(e.RENDERBUFFER, r, l, n.width, n.height)
                } else
                    e.renderbufferStorage(e.RENDERBUFFER, l, n.width, n.height)
            }
            ...
            if (t.depthTexture) {
                ...
                !function(t, n) {
                    ...
                    if (1026 === n.depthTexture.format)
                        e.framebufferTexture2D(e.FRAMEBUFFER, e.DEPTH_ATTACHMENT, e.TEXTURE_2D, i, 0);
                    else {
        ...
        this.setTexture2DArray = function(t, i) {
            var a = r.get(t);
            t.version > 0 && a.__version !== t.version ? C(a, t, i) : (n.activeTexture(e.TEXTURE0 + i),
        ...
        this.setupRenderTarget = function(i) {
            ...
            } else if (a.__webglFramebuffer = e.createFramebuffer(),
            h)
                if (c) {
                    ...
                    var m = o.convert(i.texture.format)
                      ...
                      , b = O(i);
                    e.renderbufferStorageMultisample(e.RENDERBUFFER, b, v, i.width, i.height),
                    e.bindFramebuffer(e.FRAMEBUFFER, a.__webglMultisampledFramebuffer),
                    e.framebufferRenderbuffer(e.FRAMEBUFFER, e.COLOR_ATTACHMENT0, e.RENDERBUFFER, a.__webglColorRenderbuffer),
                    e.bindRenderbuffer(e.RENDERBUFFER, null),
                    i.depthBuffer && (a.__webglDepthRenderbuffer = e.createRenderbuffer(),
                ...
                e.texParameteri(e.TEXTURE_2D_ARRAY, e.TEXTURE_MAG_FILTER, e.NEAREST),
                e.texParameteri(e.TEXTURE_2D_ARRAY, e.TEXTURE_MIN_FILTER, e.NEAREST),
                e.texImage3D(e.TEXTURE_2D_ARRAY, 0, e.RGBA8, w, T, S, 0, e.RGBA, e.UNSIGNED_BYTE, null),
                A.framebufferTextureMultiviewOVR(e.FRAMEBUFFER, e.COLOR_ATTACHMENT0, L, 0, 0, S);
                var R = e.createTexture();
                e.bindTexture(e.TEXTURE_2D_ARRAY, R),
                e.texParameteri(e.TEXTURE_2D_ARRAY, e.TEXTURE_MAG_FILTER, e.NEAREST),
                e.texParameteri(e.TEXTURE_2D_ARRAY, e.TEXTURE_MIN_FILTER, e.NEAREST),
                e.texImage3D(e.TEXTURE_2D_ARRAY, 0, e.DEPTH24_STENCIL8, w, T, S, 0, e.DEPTH_STENCIL, e.UNSIGNED_INT_24_8, null),
                A.framebufferTextureMultiviewOVR(e.FRAMEBUFFER, e.DEPTH_STENCIL_ATTACHMENT, R, 0, 0, S);
                var P = new Array(S);
                for (p = 0; p < S; ++p)
                    P[p] = e.createFramebuffer(),
                    e.bindFramebuffer(e.FRAMEBUFFER, P[p]),
                    e.framebufferTextureLayer(e.FRAMEBUFFER, e.COLOR_ATTACHMENT0, L, 0, p);
            ...
            if (u) {
                ...
                for (p = 0; p < 6; p++)
                    I(a.__webglFramebuffer[p], i, e.COLOR_ATTACHMENT0, e.TEXTURE_CUBE_MAP_POSITIVE_X + p);
                x(i.texture, f) && y(e.TEXTURE_CUBE_MAP, i.texture, i.width, i.height),
                n.bindTexture(e.TEXTURE_CUBE_MAP, null)
            } else
                d || (n.bindTexture(e.TEXTURE_2D, l.__webglTexture),
        ...
        this.safeSetTextureCube = function(e, t) {
            e && e.isWebGLRenderTargetCube && (!1 === B && (console.warn("THREE.WebGLTextures.safeSetTextureCube: don't use cube render targets as textures. Use their .texture property instead."),
            B = !0),
            e = e.texture),
    ...
    function Li(e, t, n) {
        ...
        return {
            convert: function(n) {
                ...
                return 36196 === n ? null !== (r = t.get("WEBGL_compressed_texture_etc1")) ? r.COMPRESSED_RGB_ETC1_WEBGL : null : 37808 === n || 37809 === n || 37810 === n || 37811 === n || 37812 === n || 37813 === n || 37814 === n || 37815 === n || 37816 === n || 37817 === n || 37818 === n || 37819 === n || 37820 === n || 37821 === n ? null !== (r = t.get("WEBGL_compressed_texture_astc")) ? n : null : 1020 === n ? i ? e.UNSIGNED_INT_24_8 : null !== (r = t.get("WEBGL_depth_texture")) ? r.UNSIGNED_INT_24_8_WEBGL : null : void 0
            }
        }
    }
    function Ri(e, t, n, i) {
    ...
    function Pi(e, t) {
        var n, i, r, a, l, c, u, h = e.extensions, d = e.properties, f = 0;
        function p(e) {
            return e.isArrayCamera ? e.cameras : (l[0] = e,
            l)
        }
        ...
        this.attachCamera = function(t) {
            !1 !== function(e) {
                ...
                for (var n = 1, i = t.length; n < i; n++)
                    if (t[0].viewport.z !== t[n].viewport.z || t[0].viewport.w !== t[n].viewport.w)
                        return !1;
                return !0
            }(t) && (i = e.getRenderTarget(),
            function(t) {
                if (i ? c.set(i.width, i.height) : e.getDrawingBufferSize(c),
                t.isArrayCamera) {
                    var r = t.cameras[0].viewport;
                    n.setSize(r.z, r.w),
                    n.setNumViews(t.cameras.length)
                } else
                    n.setSize(c.x, c.y),
                    n.setNumViews(2)
            }(t),
        ...
        this.detachCamera = function(r) {
            n === e.getRenderTarget() && (e.setRenderTarget(i),
            function(e) {
                var i = n
                  , r = i.numViews
                ...
                if (e.isArrayCamera)
                    for (var l = 0; l < r; l++) {
                        ...
                        t.blitFramebuffer(0, 0, o, s, h, f, p, m, t.COLOR_BUFFER_BIT, t.NEAREST)
                    }
                else
                    t.bindFramebuffer(t.READ_FRAMEBUFFER, a[0]),
                    t.blitFramebuffer(0, 0, o, s, 0, 0, c.x, c.y, t.COLOR_BUFFER_BIT, t.NEAREST)
            }(r))
        }
        ,
    ...
    function Ui(e, t) {
        ...
        this.getController = function(e) {
            var t = s[e];
            return void 0 === t && ((t = new Ii).matrixAutoUpdate = !1,
            t.visible = !1,
            s[e] = t),
            t
        }
    ...
    Ri.prototype = Object.assign(Object.create(bi.prototype), {
        ...
        setNumViews: function(e) {
            return this.numViews !== e && (this.numViews = e,
            this.dispose()),
            this
        }
    }),
    ...
    Di.prototype = Object.assign(Object.create(Ni.prototype), {
        ...
        copy: function(e, t) {
            return Ni.prototype.copy.call(this, e, t),
            this.fov = e.fov,
            this.zoom = e.zoom,
            this.near = e.near,
            this.far = e.far,
        ...
        getFocalLength: function() {
            var e = Math.tan(.5 * i.a.DEG2RAD * this.fov);
            return .5 * this.getFilmHeight() / e
        },
        getEffectiveFOV: function() {
            return 2 * i.a.RAD2DEG * Math.atan(Math.tan(.5 * i.a.DEG2RAD * this.fov) / this.zoom)
        },
        ...
        updateProjectionMatrix: function() {
            var e = this.near
              , t = e * Math.tan(.5 * i.a.DEG2RAD * this.fov) / this.zoom
              , n = 2 * t
              , r = this.aspect * n
              , a = -.5 * r
              , o = this.view;
    ...
    Oi.prototype = Object.assign(Object.create(Se.prototype), {
        ...
        copy: function(e) {
            return Se.prototype.copy.call(this, e),
    ...
    function Zi() {
        qi.call(this, new Yi(-5,5,5,-5,.5,500))
    }
    function Ji(e, t) {
        Xi.call(this, e, t),
    ...
    Ji.prototype = Object.assign(Object.create(Xi.prototype), {
        ...
        copy: function(e) {
            return Xi.prototype.copy.call(this, e),
    ...
    function or(e, t, n, i) {
        ...
        var r, a, s = [], l = [], c = [], u = [], h = new d.a, f = new o.a;
        for (l.push(0, 0, 0),
        c.push(0, 0, 1),
        u.push(.5, .5),
        a = 0,
    ...
    function lr(e, t, n, i) {
        ...
        !function(e) {
            for (var n = new d.a, i = new d.a, r = new d.a, a = 0; a < t.length; a += 3)
                c(t[a + 0], n),
                c(t[a + 1], i),
                c(t[a + 2], r),
                s(n, i, r, e)
        ...
        function() {
            for (var e = new d.a, t = 0; t < r.length; t += 3) {
                ...
                var n = h(e) / 2 / Math.PI + .5
                  , i = (s = e,
                Math.atan2(-s.y, Math.sqrt(s.x * s.x + s.z * s.z)) / Math.PI + .5);
                a.push(n, 1 - i)
            }
            var s;
            (function() {
                for (var e = new d.a, t = new d.a, n = new d.a, i = new d.a, s = new o.a, l = new o.a, c = new o.a, f = 0, p = 0; f < r.length; f += 9,
                p += 6) {
    ...
    function ur(e, t) {
        ...
        lr.call(this, i, [0, 11, 5, 0, 5, 1, 0, 1, 7, 0, 7, 10, 0, 10, 11, 1, 5, 9, 5, 11, 4, 11, 10, 2, 10, 7, 6, 7, 1, 8, 3, 9, 4, 3, 4, 2, 3, 2, 6, 3, 6, 8, 3, 8, 9, 4, 9, 5, 2, 4, 11, 6, 2, 10, 8, 6, 7, 9, 8, 1], e, t),
                ...
                if (i.isBufferGeometry) {
                    ...
                    if (null !== f)
                        for (var m = f.array, g = 0, v = m.length - 1; g < v; g += h) {
                            var _ = m[g]
                              , x = m[g + 1];
                            if (s.fromArray(p, 3 * _),
                            l.fromArray(p, 3 * x),
                            !(tr.distanceSqToSegment(s, l, u, c) > o))
                                u.applyMatrix4(this.matrixWorld),
                                (b = e.ray.origin.distanceTo(u)) < e.near || b > e.far || t.push({
                                    distance: b,
    ...
    const hr = !!navigator.platform.match(/iPhone|iPod/) || !!window.matchMedia("(max-width: 736px)").matches
      , dr = {
        physical: n(8).CustomMeshPhysicalShader
    }
    ...
    var vr = new function(e) {
        ...
        var v, _, x, y, M, b, w, E, T, S, A, L, R, P, N, D, C, I, U = this, O = !1, z = null, B = 0, G = 0, V = null, H = null, k = -1, j = {
            geometry: null,
            program: null,
            wireframe: !1
        }, Y = null, Q = null, K = new J, $ = new J, ee = null, te = t.width, ne = t.height, ie = 1, re = null, ae = null, oe = new J(0,0,te,ne), se = new J(0,0,te,ne), le = !1, ce = new F, ue = new Vt, he = !1, de = !1, fe = new W, pe = new d.a;
        function me() {
            return null === V ? ie : 1
        }
        try {
            ...
            if (t.addEventListener("webglcontextlost", Ee, !1),
            t.addEventListener("webglcontextrestored", Te, !1),
            null === (v = n || t.getContext("webgl", xe) || t.getContext("experimental-webgl", xe)))
        ...
        function ye() {
            _ = new Ht(v),
            !1 === (x = new Gt(v,_,e)).isWebGL2 && (_.get("WEBGL_depth_texture"),
        ...
        this.setSize = function(e, n, i) {
            Me.isPresenting ? console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.") : (te = e,
            ne = n,
        ...
        this.renderBufferDirect = function(e, t, n, i, r, a) {
            ...
            y.setMaterial(i, o);
            var l = !1;
            j.geometry === n.id && j.program === s.id && j.wireframe === (!0 === i.wireframe) || (j.geometry = n.id,
            j.program = s.id,
            j.wireframe = !0 === i.wireframe,
            l = !0),
            (i.morphTargets || i.morphNormals) && (N.update(r, n, i, s),
            l = !0);
            var c = n.index
            ...
            if (null === c) {
                ...
                return;
            var h, d = 1;
            !0 === i.wireframe && (c = T.getWireframeAttribute(n),
            d = 2);
            var f = D;
            null !== c && (h = E.get(c),
            (f = C).setIndex(h)),
                ...
                for (var s in a) {
                    ...
                    if (l >= 0) {
                        ...
                        if (void 0 !== c) {
                            ...
                            var b;
                            if (void 0 === (b = E.get(e.instanceMatrix)))
                                continue;
                            d = b.buffer,
                            f = b.type;
            ...
            if (0 !== A) {
                if (r.isMesh)
                    !0 === i.wireframe ? (y.setLineWidth(i.wireframeLinewidth * me()),
                    f.setMode(v.LINES)) : f.setMode(v.TRIANGLES);
                else if (r.isLine) {
                    var L = i.linewidth;
                    void 0 === L && (L = 1),
                    y.setLineWidth(L * me()),
                    r.isLineSegments ? f.setMode(v.LINES) : r.isLineLoop ? f.setMode(v.LINE_LOOP) : f.setMode(v.LINE_STRIP)
                } else
                    r.isPoints ? f.setMode(v.POINTS) : r.isSprite && f.setMode(v.TRIANGLES);
                r.isInstancedMesh ? f.renderInstances(n, w, A, r.count) : n.isInstancedBufferGeometry ? f.renderInstances(n, w, A, n.maxInstancedCount) : f.render(w, A)
            }
        }
        ,
                ...
                if (e.layers.test(t.layers))
                    ...
                    !e.frustumCulled || ce.intersectsObject(e))) {
                        ...
                        if (Array.isArray(a))
                            ...
                            a.visible && m.push(e, r, a, n, pe.z, null)
                    }
                var h = e.children;
                for (s = 0,
                l = h.length; s < l; s++)
        ...
        function De(e, t, n, i) {
            for (var r = 0, a = e.length; r < a; r++) {
                ...
                if (n.isArrayCamera)
                    if (Q = n,
                    Me.enabled && be.isAvailable())
                        Ce(s, t, n, l, c, u);
                    else
                        for (var h = n.cameras, d = 0, f = h.length; d < f; d++) {
                            var p = h[d];
                            s.layers.test(p.layers) && (y.viewport(K.copy(p.viewport)),
                            g.setupLights(p),
                            Ce(s, t, p, l, c, u))
                        }
                else
        ...
        function Ce(e, t, n, i, r, a) {
            if (e.onBeforeRender(U, t, n, i, r, a),
            g = R.get(t, Q || n),
            ...
            e.isImmediateRenderObject) {
                ...
                U.renderBufferDirect(n, t, i, r, e, a);
            e.onAfterRender(U, t, n, i, r, a),
            g = R.get(t, Q || n)
        }
        function Ie(e, t, n) {
            var i = b.get(e)
              ...
              , o = r.state.version
              , s = A.getParameters(e, r.state, a, t, ue.numPlanes, ue.numIntersection, n)
            ...
            (e.isShaderMaterial || e.isRawShaderMaterial) && !0 !== e.clipping || (i.numClippingPlanes = ue.numPlanes,
        ...
        function Ue(e, t, n, r) {
            ...
            if (he && (de || e !== Y)) {
                var c = e === Y && n.id === k;
                ue.setState(n.clippingPlanes, n.clipIntersection, n.clipShadows, e, s, c)
            }
            n.version === s.__version && (void 0 === s.program || n.fog && s.fog !== a || s.environment !== o || s.needsLights && s.lightsStateVersion !== l.state.version ? n.needsUpdate = !0 : void 0 === s.numClippingPlanes || s.numClippingPlanes === ue.numPlanes && s.numIntersection === ue.numIntersection ? s.outputEncoding !== U.outputEncoding && (n.needsUpdate = !0) : n.needsUpdate = !0),
            n.version !== s.__version && (Ie(n, t, r),
            s.__version = n.version);
            var u, d, f = !1, p = !1, m = !1, _ = s.program, M = _.getUniforms(), E = s.shader.uniforms;
            if (y.useProgram(_.program) && (f = !0,
            p = !0,
            m = !0),
            n.id !== k && (k = n.id,
            p = !0),
            f || Y !== e) {
                if (_.numMultiviewViews > 0 ? be.updateCameraProjectionMatricesUniform(e, M) : M.setValue(v, "projectionMatrix", e.projectionMatrix),
                x.logarithmicDepthBuffer && M.setValue(v, "logDepthBufFC", 2 / (Math.log(e.far + 1) / Math.LN2)),
                Y !== e && (Y = e,
                p = !0,
                m = !0),
                n.isShaderMaterial || n.isMeshPhongMaterial || n.isMeshToonMaterial || n.isMeshStandardMaterial || n.envMap) {
                    ...
                    void 0 !== T && T.setValue(v, pe.setFromMatrixPosition(e.matrixWorld))
                }
                (n.isMeshPhongMaterial || n.isMeshToonMaterial || n.isMeshLambertMaterial || n.isMeshBasicMaterial || n.isMeshStandardMaterial || n.isShaderMaterial) && M.setValue(v, "isOrthographic", !0 === e.isOrthographicCamera),
                (n.isMeshPhongMaterial || n.isMeshToonMaterial || n.isMeshLambertMaterial || n.isMeshBasicMaterial || n.isMeshStandardMaterial || n.isShaderMaterial || n.skinning) && (_.numMultiviewViews > 0 ? be.updateCameraViewMatricesUniform(e, M) : M.setValue(v, "viewMatrix", e.matrixWorldInverse))
            }
            if (n.skinning) {
                ...
                if (S) {
                    ...
                    if (x.floatVertexTextures) {
                        ...
                        M.setOptional(v, S, "boneMatrices")
                }
            }
            return (p || s.receiveShadow !== r.receiveShadow) && (s.receiveShadow = r.receiveShadow,
            M.setValue(v, "receiveShadow", r.receiveShadow)),
            p && (M.setValue(v, "toneMappingExposure", U.toneMappingExposure),
            ...
            n.isMeshBasicMaterial ? Fe(E, n) : n.isMeshLambertMaterial ? (Fe(E, n),
            function(e, t) {
                t.emissiveMap && (e.emissiveMap.value = t.emissiveMap)
            }(E, n)) : n.isMeshToonMaterial ? (Fe(E, n),
            function(e, t) {
            ...
            }(E, n)) : n.isMeshPhongMaterial ? (Fe(E, n),
            function(e, t) {
                e.specular.value.copy(t.specular),
                e.shininess.value = Math.max(t.shininess, 1e-4),
                t.emissiveMap && (e.emissiveMap.value = t.emissiveMap);
                ...
                e.displacementScale.value = t.displacementScale,
                e.displacementBias.value = t.displacementBias)
            }(E, n)) : n.isMeshStandardMaterial ? (Fe(E, n, o),
            ...
            }(E, n, o) : Oe(E, n, o)) : n.isMeshMatcapMaterial ? (Fe(E, n),
            function(e, t) {
                ...
                e.displacementScale.value = t.displacementScale,
                e.displacementBias.value = t.displacementBias)
            }(E, n)) : n.isMeshDepthMaterial ? (Fe(E, n),
            function(e, t) {
                t.displacementMap && (e.displacementMap.value = t.displacementMap,
                e.displacementScale.value = t.displacementScale,
                e.displacementBias.value = t.displacementBias)
            }(E, n)) : n.isMeshDistanceMaterial ? (Fe(E, n),
            function(e, t) {
                t.displacementMap && (e.displacementMap.value = t.displacementMap,
                e.displacementScale.value = t.displacementScale,
                e.displacementBias.value = t.displacementBias);
            ...
            }(E, n)) : n.isMeshNormalMaterial ? (Fe(E, n),
            function(e, t) {
                t.bumpMap && (e.bumpMap.value = t.bumpMap,
                e.bumpScale.value = t.bumpScale,
                1 === t.side && (e.bumpScale.value *= -1));
            ...
            n.isShaderMaterial && !0 === n.uniformsNeedUpdate && (Xn.upload(v, s.uniformsList, E, w),
            n.uniformsNeedUpdate = !1),
            n.isSpriteMaterial && M.setValue(v, "center", r.center),
            _.numMultiviewViews > 0 ? be.updateObjectMatricesUniforms(r, e, M) : (M.setValue(v, "modelViewMatrix", r.modelViewMatrix),
        ...
        this.render = function(e, t) {
            ...
            t && t.isCamera) {
                if (!O) {
                    ...
                    null !== V && (w.updateRenderTargetMipmap(V),
        ...
        this.setFramebuffer = function(e) {
            z !== e && null === V && v.bindFramebuffer(v.FRAMEBUFFER, e),
            z = e
        }
        ,
        ...
        this.setRenderTarget = function(e, t, n) {
            ...
            B = t,
            G = n,
            e && void 0 === b.get(e).__webglFramebuffer && w.setupRenderTarget(e);
            var i = z
              , r = !1;
            if (e) {
                var a = b.get(e).__webglFramebuffer;
                e.isWebGLRenderTargetCube ? (i = a[t || 0],
                ...
                ee = le;
            if (H !== i && (v.bindFramebuffer(v.FRAMEBUFFER, i),
            H = i),
            y.viewport(K),
            y.scissor($),
            y.setScissorTest(ee),
        ...
        this.readRenderTargetPixels = function(e, t, n, i, r, a, o) {
            if (e && e.isWebGLRenderTarget) {
                ...
                if (e.isWebGLRenderTargetCube && void 0 !== o && (s = s[o]),
                s) {
                    var l = !1;
                    s !== H && (v.bindFramebuffer(v.FRAMEBUFFER, s),
                    l = !0);
                    try {
                        var c = e.texture
                          , u = c.format
                          , h = c.type;
                        if (1023 !== u && I.convert(u) !== v.getParameter(v.IMPLEMENTATION_COLOR_READ_FORMAT))
                            return void console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");
                        if (!(1009 === h || I.convert(h) === v.getParameter(v.IMPLEMENTATION_COLOR_READ_TYPE) || 1015 === h && (x.isWebGL2 || _.get("OES_texture_float") || _.get("WEBGL_color_buffer_float")) || 1016 === h && (x.isWebGL2 ? _.get("EXT_color_buffer_float") : _.get("EXT_color_buffer_half_float"))))
                            return void console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");
                        v.checkFramebufferStatus(v.FRAMEBUFFER) === v.FRAMEBUFFER_COMPLETE ? t >= 0 && t <= e.width - i && n >= 0 && n <= e.height - r && v.readPixels(t, n, i, r, I.convert(u), I.convert(h), a) : console.error("THREE.WebGLRenderer.readRenderTargetPixels: readPixels from renderTarget failed. Framebuffer not complete.")
                    } finally {
        ...
        this.copyTextureToTexture = function(e, t, n, i) {
            var r = t.image.width
              ...
              , s = I.convert(n.type);
            w.setTexture2D(n, 0),
            t.isDataTexture ? v.texSubImage2D(v.TEXTURE_2D, i || 0, e.x, e.y, r, a, o, s, t.image.data) : v.texSubImage2D(v.TEXTURE_2D, i || 0, e.x, e.y, o, s, t.image),
            y.unbindTexture()
        }
        ,
    ...
    (vr.domElement.getContext("webgl") || vr.domElement.getContext("experimental-webgl")).getExtension("OES_standard_derivatives"),
    fr.appendChild(vr.domElement);
    const _r = new Worker("/worker/worker-physics.js")
      , xr = Math.round((yr = window.innerWidth,
    ...
    var Nr = new Fi
      , Dr = new ur(1,3);
    Nr.copy(Dr);
    let Cr = new Oi(new Float32Array(xr).map(e=>Math.random()),1);
    Nr.setAttribute("instanceRandom", Cr);
    let Ir = new Oi(new Float32Array(xr).map((e,t)=>Tr.scales[4 * t + 4]),1).setUsage(35048);
    ...
    let Ur = new class {
        ...
        update(e) {
            ...
            this.uniforms.uScale.value = e.scale.x * Math.max(1 - Qr, .25),
            e.scale.x <= .001 && (this.uniforms.uRandom.value = Math.random())
        }
    }
    (1).material
      , Fr = new Hi(Nr,Ur,xr);
    ...
    var ra = function() {
        ...
        Pr.length < xr && Gr > 5 && (Sr = !0,
        Pr.push(1),
        Gr = 0),
        Pr.forEach((e,t)=>{
            ea.set(Tr.positions[3 * t + 0], Tr.positions[3 * t + 1], Tr.positions[3 * t + 2]),
            ta.set(Tr.quaternions[4 * t + 0], Tr.quaternions[4 * t + 1], Tr.quaternions[4 * t + 2], Tr.quaternions[4 * t + 3]),
        ...
        Kr = Vr.scrollTop / (kr - Hr),
        Qr += .01 * (Kr - Qr),
        hr && qr.set(.25 * Math.cos(ia * Math.PI), .5 * Math.cos(ia)),
        Xr.lerp(qr, .15),
        jr.setFromCamera(Xr, gr),
        jr.ray.intersectPlane(Wr, Jr),
        zr.position.copy(Jr),
        Yr.setScalar(Zr ? .25 + .5 * Xr.distanceToSquared(qr) : .1),
        zr.rotateZ(-.2 * zr.scale.x),
        zr.scale.lerp(Yr, .06),
        vr.render(mr, gr)
    };
    function aa(e) {
        ...
        qr.set(e.clientX / window.innerWidth * 2 - 1, -e.clientY / pr() * 2 + 1)
    }
    Lr(),
    ra(),
    ...
    ,
    window.PointerEvent ? document.addEventListener("pointermove", aa, !1) : document.addEventListener("mousemove", aa, !1),
